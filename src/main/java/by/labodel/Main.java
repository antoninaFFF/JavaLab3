...
import by.labodel.entities.actions.Decided;
import by.labodel.entities.actions.Huge;
import by.labodel.entities.location.OldHouse;
import by.labodel.entities.location.StateType;
import by.labodel.entities.alive.MainPerson;
import by.labodel.entities.location.Grotto;
import by.labodel.entities.location.Location;
import by.labodel.entities.thing.Ammunition;
import by.labodel.entities.thing.Gun;
import by.labodel.entities.thing.Musket;
